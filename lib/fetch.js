 ...
 */
module.exports = function(pkgName, toDir, callback) {
    ...
    if (!fs.existsSync(toDir)) {
        require('mkdirp').sync(toDir);
    }

    var tasks = [
        fetchPackageMeta(name, version, toDir),
        fetchPackageDetail(name, version, toDir),
        downloadPackageArchive(name, version, toDir)
    ];
 ...
 * @return {function}
 */
function fetchPackageMeta(name, version, toDir, callback) {
    return function(callback) {
        ...
        httpGet(url, function(error, data){
            ...
            var ver = semver.maxSatisfying(candidates, version);
 ...
 * @return {function}
 */
function fetchPackageDetail(name, version, toDir, callback) {
 ...
 * @return {function}
 */
function downloadPackageArchive(name, version, toDir, callback) {
